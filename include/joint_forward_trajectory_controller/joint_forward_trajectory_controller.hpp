...
#include "joint_forward_trajectory_controller/joint_forward_trajectory_controller_parameters.hpp"
...
protected:
  ...
  // Parameters from ROS for joint_forward_trajectory_controller
